  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Get in touch with me through my contact page." />
        <meta name="og:title" content="Portfolio of Javohir Muradov(Java)." />
        <meta name="og:description" content="Get in touch with me through my contact page." />
      </Helmet>
