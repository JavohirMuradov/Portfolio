...
const Contact = () => {
  ...
  const sendEmail = () => {
    emailjs
      ...
      }).then(() => console.log("Secces")).catch(() => console.log("error"))
  };
  ...
  return (
    <main className='bg-primary text-secondary font-forum'>
      <section className="container py-10 flex flex-col items-center justify-center gap-5 h-full pt-36">
        ...
        <Card className="flex lg:flex-row flex-col items-center lg:items-start w-full bg-transparent justify-between shadow-none">
          ...
          <CardBody className="w-full flex flex-col gap-5">
            ...
            <form className="flex flex-col gap-4 items-center w-full justify-between h-full" onSubmit={(e) => Submitt(e)} ref={form}>
